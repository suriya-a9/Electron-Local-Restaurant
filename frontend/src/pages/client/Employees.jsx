                            ...
                            >
                                ...
                                <div className="flex items-center gap-2 lg:justify-end">
                                    ...
                                    <button
                                        ...
                                        className="flex items-center gap-2 rounded-xl border border-zinc-200 bg-white px-4 py-2 text-xs font-semibold text-zinc-700 transition-colors hover:border-indigo-300 hover:text-indigo-600"
                                    >
                                        <Pencil size={14} />
